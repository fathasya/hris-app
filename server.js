...
const masterdata = require('./controllers/master-data')
const dataPegawai = require('./controllers/data-pegawai')
const dataAbsensi = require('./controllers/data-absensi')
const formAddAbsensi = require('./controllers/add-absensi')
const addActivity = require('./controllers/add-activity')
const dailyActivity = require('./controllers/daily-activity')
const pengajuanCuti = require('./controllers/pengajuan-cuti')
const dataCutiPegawai = require('./controllers/data-cuti-pegawai')
const dataAbsensiPegawai = require('./controllers/data-absensi-pegawai')
const ubahPassword = require('./controllers/ubah-password')
